var Model = function (wrapper, canvas) {
    ...
    this.renderer.setSize(this.wrapper.width(), this.wrapper.height() * 2);

    // load the model including materials
    var model_file = 'quad_x';
...
Model.prototype.loadJSON = function (model_file, callback) {
    ...
    loader.load('./static/models/' + model_file + '.json', function (geometry, materials) {
